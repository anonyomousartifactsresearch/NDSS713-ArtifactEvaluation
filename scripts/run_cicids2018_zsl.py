...
def evaluate_on_test_set(model, test_loader, train_df, feature_groups, label_map, device, label_column, title=""):
...
def main():
    ...
    evaluate_on_test_set(model, test_loader, train_df, feature_groups, full_label_map, device, label_column, title="CICIDS2018 Test Set")
